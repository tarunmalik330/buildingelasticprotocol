...
const Header = () => {
  ...
  return (
    <div className="bg-header">
      <Container className="custum_container">
        <div className="d-flex align-items-center justify-content-between py-lg-1 py-2">
          <img
            src={Pagelogo}
            alt="Pagelogo"
            className="mw-68 w-100 cur-pointer"
          />
          <div className="d-flex align-items-center justify-content-between gap-btn">
            ...
            <button className="btn-enter1">Enter App</button>
            ...
            <button className="btn-enter d-lg-block d-none position-relative z-2">
              Enter App
            </button>
          </div>
        </div>
      ...
      <Container className="custum_container">
        <Row className="head-padding align-items-center">
          <Col
            lg={6}
