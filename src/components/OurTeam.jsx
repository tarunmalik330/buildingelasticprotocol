    ...
    <>
      <div id="Team" className="bg_team">
        <Container className="custum_container">
          <h2 className="text-white fs_6xl ff_NeueMachinaUltrabold text-center lh_120 text-capitalize py_team">
            our Team
          </h2>
          <Row className="align-items-center justify-content-center">
            ...
            <Col md={4} sm={6} className="col-12 pt-4 pb-4 pt-md-0 pb-md-0">
              <div className="card_team">
            ...
            <Col md={4} sm={6} className="col-12 pb-5 pb-md-0">
              <div className="card_team">
